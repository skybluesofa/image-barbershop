...
class ClassBalancedTest extends TestCase
{
    ...
    {
        $croppedImage = (new CropBalanced)->onFile(__DIR__ . self::EXAMPLE_IMAGE)->getResults(200, 200);
        $croppedImage->writeimage($this->tempDir . DIRECTORY_SEPARATOR . 'balanced-test.png');

        $expectedImage = new \Imagick(__DIR__ . DIRECTORY_SEPARATOR . 'images' . DIRECTORY_SEPARATOR . 'balanced-expected.png');
    ...
    public function testEntropyWithPreviousImagick()
    {
        ...
        $croppedImage = (new CropBalanced)->onImage($image)->toSize(200, 200)->getResults();
